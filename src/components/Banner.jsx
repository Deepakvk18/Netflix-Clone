...
export default function Banner({ nth }) {
  ...
  return (
    <header className='relative rounded-lg to-black w-[99.3vw] h-[70vh] lg:h-[90vh] text-white object-contain flex justify-start mb-4 ' style={{
        backgroundSize: 'cover',
        backgroundImage: `url(https://image.tmdb.org/t/p/original/${movie?.backdrop_path})`,
        backgroundPosition: 'center'
    }}>
        <div className="absolute h-[70vh] lg:h-[90vh] inset-0  w-[100vw] lg:w-[99.3vw] z-10 bg-gradient-to-b from-[rgba(0,0,0,0.8)] via-[rgba(0,0,0,0.6)] to-[rgba(0,0,0,0.8)] float-left" />  
        <div className='block z-30'>
          <div className='pt-44 md:pt-80 lg:pt-44 mx-11 h-14 lg:w-[50%]'>
              <div className='mt-8'>
                <h1 className="text-4xl xl:text-6xl font-bold ml-0 mb-5">
              ...
              <div>
                ...
                <button className='cursor-pointer font-semibold text-lg border-radius-[0.2vw] px-6 mr-4 py-2 rounded-md bg-buttonBg text-white hover:opacity-80 sm:mt-4' onClick={()=>navigate(`/details/${'tv'}/${movie?.id}`)}>
